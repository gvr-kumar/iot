...
public class StaticMain {
	...
	public static void main(String[] args) {
		...
		stUtils.static_var = stUtils.static_var + 10;  
		stUtils.nonStatic_var = stUtils.nonStatic_var + 10;
		System.out.println("stUtils.static_var: " + stUtils.static_var);
		System.out.println("stUtils.nonStatic_var: " + stUtils.nonStatic_var);
		...
		StaticUtils stUtils1 = new StaticUtils();
		stUtils1.static_var = stUtils1.static_var + 10;
		stUtils1.nonStatic_var = stUtils1.nonStatic_var - 10;
